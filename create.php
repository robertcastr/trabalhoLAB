...
//Inserindo no Banco:
    if ($validacao) {
        ...
        $sql = "INSERT INTO pessoa (nome, endereco, telefone, email, numero) VALUES(?,?,?,?,?)";
        $q = $pdo->prepare($sql);
        $q->execute(array($nome, $endereco, $telefone, $email, $numero));
        Banco::desconectar();
            ...
            <div class="card-body">
                <form class="form-horizontal" action="create.php" method="post">
                    ...
                    <div class="control-group <?php echo !empty($numeroErro) ? 'error ' : ''; ?>">
                        ...
                        <div class="controls">
                            <input size="35" class="form-control" name="telefone" type="text" placeholder="Numero"
